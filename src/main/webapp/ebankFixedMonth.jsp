...
<%String loginAccount = "00003333"; // 這邊示範先寫死%>
                        ...
                        <section>
                            ...
                            <div class="card">
                                ...
                                <script>
								  ...
								  dateSelect.addEventListener("change", updateDataDisplay);
								
								  function updateDataDisplay() {
									  const dateSelect = document.getElementById("DateSelect");
									  const selectedOption = dateSelect.options[dateSelect.selectedIndex].value;


									  if (selectedOption === "date1") {
									    // 根據日期排序新到舊
									    data.sort((a, b) => new Date(b.date) - new Date(a.date));
									  } else if (selectedOption === "date2") {
									    // 根據日期排序舊到新
                                ...
                                <div class="card-body d-none" id="search">   
                                    ...
                                    <script>
										function searchTransactions() {
										  ...
										  xhttp.open("GET", "dateSearch.jsp?startDate=" + startDate + "&endDate=" + endDate, true);
										  xhttp.send();
										}

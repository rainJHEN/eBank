...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	//FortexTrade_model model = (FortexTrade_model)session.getAttribute("FortexTrade_model");
%>
<!DOCTYPE html>
<!-- Ver0.8 -->
<html lang="en">
                ...
                <div class="container-fluid text-light mx-5" style="background-color: #b7b7b766; border-radius: 15px;margin-bottom: 30px;">
                    <div class="row align-items-center justify-content-between d-flex">
                        ...
                        <div class="col-md p-3" style="color: black;font-size: 18px;display: flex; justify-content: center; align-items: center;flex-direction: column;">
                              ...
                              <h2 class="my-3" style="text-align: center">外匯交易成功</h2>

                            <P style="color: black;">
                                <h3>轉出帳號</h3>
                                <h5>0000000002</h5>
                              <h5>剩餘餘額:79554.24<span>(美元)</span></h5>
                            </P>

                            <div class="container" style="display: flex; justify-content: center; align-items: center; flex-direction: column;">
                                <span style="margin-bottom: 10px; font-weight: bold;"><h3>轉帳資訊</h3></span>
                                <h5>轉入帳號:0000000002</h5>
                                <h5>轉入金額:89.99<span>(歐元)</span></h5>
                                <h5>轉帳日期:<span id="dateMoney"></span></h5> <!-- id="dateMoney"今天日期給當下的交易 -->
                                <br>
                                <!-- <caption>交易備註(選填)</caption>
                                <input type = "text" placeholder="請輸入最多12位中英數字" style="width: 250px;"> -->
                            </div>
                            <!-- 收款人的container-div結束 -->
                            <div class="container" style="display: flex; justify-content: center; align-items: center;">
                                <button class="custom-btn btn-2 btn-lg" style="width: 150px;height: 45px;margin-top: -10px;">回首頁</button>
                            </div>
